...
- **官方 V4 Pro 下线计划（2026-09-10 官方公告，插件尚未按时间处理）**：北京时间 2026-09-14 12:00 之后、V4.1 Pro 上线之前，`deepseek-v4-pro` 的请求将由 V4.1 Flash 提供服务并按 Flash 价格计费。插件当前仍按 pro 价目计算该模型用量，那段时间若确有 pro 调用会**高估**成本。
